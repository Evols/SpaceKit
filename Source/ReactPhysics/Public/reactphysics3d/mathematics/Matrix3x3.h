...
inline Matrix3x3 Matrix3x3::computeSkewSymmetricMatrixForCrossProduct(const Vector3& vector) {
    return Matrix3x3(0.0_fl, -vector.z, vector.y, vector.z, 0.0_fl, -vector.x, -vector.y, vector.x, 0.0_fl);
}
...
inline FString Matrix3x3::to_string() const {
    return "Matrix3x3(" + URealFloatMath::ConvRealToString(mRows[0][0]) + "," + URealFloatMath::ConvRealToString(mRows[0][1]) + "," + URealFloatMath::ConvRealToString(mRows[0][2]) + "," +
           URealFloatMath::ConvRealToString(mRows[1][0]) + "," + URealFloatMath::ConvRealToString(mRows[1][1]) + "," + URealFloatMath::ConvRealToString(mRows[1][2]) + "," +
           URealFloatMath::ConvRealToString(mRows[2][0]) + "," + URealFloatMath::ConvRealToString(mRows[2][1]) + "," + URealFloatMath::ConvRealToString(mRows[2][2]) + ")";
}
