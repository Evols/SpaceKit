...
struct NarrowPhaseInfoBatch {
    ...
    public:
        ...
        virtual void addContactPoint(uint8 index, const Vector3& contactNormal, decimal penDepth,
                             const Vector3& localPt1, const Vector3& localPt2);

        /// Reset the remaining contact points
        void resetContactPoints(uint8 index);
...
/// Return the number of objects in the batch
inline uint8 NarrowPhaseInfoBatch::getNbObjects() const {
