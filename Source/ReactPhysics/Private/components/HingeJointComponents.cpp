...
void HingeJointComponents::addComponent(Entity jointEntity, bool isSleeping, const HingeJointComponent& component) {
    ...
    new (mR1World + index) Vector3(0_fl, 0_fl, 0_fl);
    new (mR2World + index) Vector3(0_fl, 0_fl, 0_fl);
    new (mI1 + index) Matrix3x3();
    new (mI2 + index) Matrix3x3();
    new (mImpulseTranslation + index) Vector3(0_fl, 0_fl, 0_fl);
    ...
    new (mBiasTranslation + index) Vector3(0_fl, 0_fl, 0_fl);
    new (mBiasRotation + index) Vector2(0_fl, 0_fl);
    new (mInitOrientationDifferenceInv + index) Quaternion(0_fl, 0_fl, 0_fl, 0_fl);
    new (mHingeLocalAxisBody1 + index) Vector3(0_fl, 0_fl, 0_fl);
    new (mHingeLocalAxisBody2 + index) Vector3(0_fl, 0_fl, 0_fl);
    new (mA1 + index) Vector3(0_fl, 0_fl, 0_fl);
    new (mB2CrossA1 + index) Vector3(0_fl, 0_fl, 0_fl);
    new (mC2CrossA1 + index) Vector3(0_fl, 0_fl, 0_fl);
