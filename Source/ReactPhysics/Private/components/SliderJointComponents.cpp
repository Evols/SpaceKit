...
void SliderJointComponents::addComponent(Entity jointEntity, bool isSleeping, const SliderJointComponent& component) {
    ...
    new (mR2 + index) Vector3(0.0_fl, 0.0_fl, 0.0_fl);
    new (mN1 + index) Vector3(0.0_fl, 0.0_fl, 0.0_fl);
    new (mN2 + index) Vector3(0.0_fl, 0.0_fl, 0.0_fl);
    mImpulseLowerLimit[index] = decimal(0.0_fl);
    mImpulseUpperLimit[index] = decimal(0.0_fl);
    mImpulseMotor[index] = decimal(0.0_fl);
    mInverseMassMatrixLimit[index] = decimal(0.0_fl);
    mInverseMassMatrixMotor[index] = decimal(0.0_fl);
    mBLowerLimit[index] = decimal(0.0_fl);
    mBUpperLimit[index] = decimal(0.0_fl);
    ...
    new (mR2CrossN1 + index) Vector3(0.0_fl, 0.0_fl, 0.0_fl);
    new (mR2CrossN2 + index) Vector3(0.0_fl, 0.0_fl, 0.0_fl);
    new (mR2CrossSliderAxis + index) Vector3(0.0_fl, 0.0_fl, 0.0_fl);
    new (mR1PlusUCrossN1 + index) Vector3(0.0_fl, 0.0_fl, 0.0_fl);
    new (mR1PlusUCrossN2 + index) Vector3(0.0_fl, 0.0_fl, 0.0_fl);
    new (mR1PlusUCrossSliderAxis + index) Vector3(0.0_fl, 0.0_fl, 0.0_fl);
