...
void RigidBodyComponents::addComponent(Entity bodyEntity, bool isSleeping, const RigidBodyComponent& component) {
    ...
    new (mConstrainedAngularVelocities + index) Vector3(0_fl, 0_fl, 0_fl);
    new (mSplitLinearVelocities + index) Vector3(0_fl, 0_fl, 0_fl);
    new (mSplitAngularVelocities + index) Vector3(0_fl, 0_fl, 0_fl);
    new (mConstrainedPositions + index) Vector3(0_fl, 0_fl, 0_fl);
    new (mConstrainedOrientations + index) Quaternion(0_fl, 0_fl, 0_fl, 1_fl);
    new (mCentersOfMassLocal + index) Vector3(0_fl, 0_fl, 0_fl);
