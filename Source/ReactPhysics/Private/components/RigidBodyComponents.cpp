...
void RigidBodyComponents::addComponent(Entity bodyEntity, bool isSleeping, const RigidBodyComponent& component) {
    ...
    new (mLinearVelocities + index) Vector3(0.0_fl, 0.0_fl, 0.0_fl);
    new (mAngularVelocities + index) Vector3(0.0_fl, 0.0_fl, 0.0_fl);
    new (mExternalForces + index) Vector3(0.0_fl, 0.0_fl, 0.0_fl);
    new (mExternalTorques + index) Vector3(0.0_fl, 0.0_fl, 0.0_fl);
    mLinearDampings[index] = decimal(0.0_fl);
    mAngularDampings[index] = decimal(0.0_fl);
    mMasses[index] = decimal(1.0_fl);
    mInverseMasses[index] = decimal(1.0_fl);
    ...
    new (mConstrainedLinearVelocities + index) Vector3(0.0_fl, 0.0_fl, 0.0_fl);
    new (mConstrainedAngularVelocities + index) Vector3(0.0_fl, 0.0_fl, 0.0_fl);
