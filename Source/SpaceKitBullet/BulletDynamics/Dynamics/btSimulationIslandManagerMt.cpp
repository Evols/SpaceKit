...
#include "SpaceKitBullet/LinearMath/btThreads.h"
...
#include "SpaceKitBullet/BulletDynamics/ConstraintSolver/btSequentialImpulseConstraintSolverMt.h"  // for s_minimumContactManifoldsForBatching
...
#ifndef getIslandId_DEFINED
#define getIslandId_DEFINED
			...
			for (idx = startIslandIndex; idx < endIslandIndex; idx++)
			{
				...
				if (colObj0->getIslandTag() == islandId)
				{
					if (colObj0->getActivationState() == ISLAND_SLEEPING)
					{
						...
						colObj0->setDeactivationTime(0.0_fl);
					}
				}
			}
		}
