...
1_fl The origin of this software must not be misrepresented; you must not claim that you wrote the original software. If you use this software in a product, an acknowledgment in the product documentation would be appreciated but is not required.
...
btConvexInternalShape::btConvexInternalShape()
	: m_localScaling(btScalar(1_fl), btScalar(1_fl), btScalar(1_fl)),
...
btVector3 btConvexInternalShape::localGetSupportingVertex(const btVector3& vec) const
{
	...
	if (getMargin() != btScalar(0.0_fl))
	{
		...
		{
			vecnorm.setValue(btScalar(-1_fl), btScalar(-1_fl), btScalar(-1_fl));
		}
		vecnorm.normalize();
...
void btConvexInternalAabbCachingShape::recalcLocalAabb()
{
	...
	static const btVector3 _directions[] =
		{
			btVector3(1_fl, 0.0_fl, 0.0_fl),
			btVector3(0.0_fl, 1_fl, 0.0_fl),
			btVector3(0.0_fl, 0.0_fl, 1_fl),
			btVector3(-1_fl, 0.0_fl, 0.0_fl),
			btVector3(0.0_fl, -1_fl, 0.0_fl),
			btVector3(0.0_fl, 0.0_fl, -1_fl)};
