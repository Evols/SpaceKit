...
#include "SpaceKitBullet/LinearMath/btTransformUtil.h"  //for btConvexSeparatingDistanceUtil
...
///Either improve GJK for large size ratios (testing a 100 units versus a 0.1_fl unit object) or only enable the util
