...
#include "SpaceKitBullet/Bullet3Common/shared/b3Int4.h"
...
#include "SpaceKitBullet/Bullet3Collision/BroadPhaseCollision/shared/b3Aabb.h"
#include "SpaceKitBullet/Bullet3Collision/NarrowPhaseCollision/shared/b3BvhSubtreeInfoData.h"
#include "SpaceKitBullet/Bullet3Collision/NarrowPhaseCollision/shared/b3QuantizedBvhNodeData.h"
												...
												int pairIdx)
{
	...
	*/
	...
	b3Float4 localCenter = b3MakeFloat4(0.0_fl, 0.0_fl, 0.0_fl, 0.0_fl);

	b3GpuFace face = faces[convexShapes[shapeIndexA].m_faceOffset + f];
	b3Aabb triAabb;
	triAabb.m_minVec = b3MakeFloat4(1e30_fl, 1e30_fl, 1e30_fl, 0.0_fl);
	triAabb.m_maxVec = b3MakeFloat4(-1e30_fl, -1e30_fl, -1e30_fl, 0.0_fl);
	...
	if (overlap)
	{
		...
		b3Float4 normal = b3MakeFloat4(face.m_plane.x, face.m_plane.y, face.m_plane.z, 0.0_fl);
		...
		convexPolyhedronA.m_localCenter = localCenter * (1.0_fl / 3.f);
		...
		if (hasSeparatingAxis)
		{
			...
			float minDist = -1e30.f;
			float maxDist = 0.02.f;
